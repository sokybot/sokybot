...
public class GuiAppender extends AppenderBase<ILoggingEvent> {
    ...
    public GuiAppender() {
	 ...
	 this.panel.add(new JScrollPane(this.textPane) , BorderLayout.CENTER) ;
	 Box toolBox = Box.createHorizontalBox() ;
	 this.btnClean.addActionListener((ev)->this.textPane.setText(""));
	 toolBox.add(this.btnClean) ; 
	 this.panel.add(toolBox , BorderLayout.NORTH) ; 
