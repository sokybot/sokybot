 ...
 * @beaninfo attribute: isContainer true description: MyDoggyToolWindowManager
 */
...
//        mainContainer.setBackground(Optional
//                .ofNullable(UIManager.getColor("toolWindowManager.mainContainer.background"))
//                .orElseGet(()->Color.GRAY));

        mainContainer.setBackground(UIManager.getColor("toolWindowManager.mainContainer.background"));
...
//                );
    ...
    public class IconChangeListener implements PropertyChangeListener {
        ...
        public void propertyChange(PropertyChangeEvent evt) {
            ...
            if (src instanceof ToolWindow) {
                getDescriptor((ToolWindow) src).getToolBar().propertyChange(evt);
            } else {
