...
public final class ToolWindowsTableModel extends DefaultTableModel implements PropertyChangeListener {
    ...
    public ToolWindowsTableModel(ToolWindowManager windowManager) {
    ...
    protected void initToolsListeners() {
        windowManager.addToolWindowManagerListener(new ToolWindowManagerListener() {
            public void toolWindowRegistered(ToolWindowManagerEvent event) {
                event.getToolWindow().addPropertyChangeListener(ToolWindowsTableModel.this);
            }

            public void toolWindowUnregistered(ToolWindowManagerEvent event) {
                updateModel();
                event.getToolWindow().removePropertyChangeListener(ToolWindowsTableModel.this);
            }
