...
public class MyDoggyResourceManager extends PropertyChangeEventSource implements ResourceManager {
    ...
    protected void onLookAndFeelChanged() {
        ...
        Properties resources = SwingUtil.loadPropertiesFile("resources.properties", classLoader);
        try {
            resources.putAll(SwingUtil.loadPropertiesFile("resources_" + n + ".properties", classLoader));
        } catch (Exception ex) {
            //ignore any error!
        }
